...
- 📥 Data Acquisition: Download [wf_optim_crypto.zip](https://drive.google.com/file/d/10DIfheR9Ub9KtvffmHcGcdc7gG3VEdWl/view?usp=sharing) (830 MB) from Google Drive and unzip it in `master\data-raw\`

- Ensure `master\data-raw\` contains the following files:
```
  master/
  └── data-raw/
      ├── data_global_train_20180101_20190930.csv  # Global training data (BTC)
      └── data_unseen_20191001_20210920.csv        # Unseen period data (BTC/ETH/BNB)
```
